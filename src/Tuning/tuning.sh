...
#
# This is the common template for the 2.x and 3.x versions of the plugin.
#
...
import MuseScore $MuseScoreImport
import QtQuick 2.2
...
MuseScore {
    ...
    {
        return element.type == $Namespace.CHORD
    }
